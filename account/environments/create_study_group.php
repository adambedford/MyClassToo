...
/*
	Check if the request is AJAX, if so, we only need core material
*/
...
<head>
  ...
  <?php if (!isset($_GET['ajax']) || $_GET['ajax']==false) { ?>
...
<?php } ?>        
        ...
        <?php include(MODULE_PATH.'/environments/create_study_group.php');?>
